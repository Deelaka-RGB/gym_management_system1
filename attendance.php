    ...
    <table>
        ...
        <?php while ($row = $trainerAttendance->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="view_attendance.php?type=trainer&id=<?= urlencode($row['attendance_id']) ?>" class="action-btn btn-view" title="View">View</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
    ...
    <table>
        ...
        <?php while ($row = $memberAttendance->fetch_assoc()): ?>
            <tr>
                ...
                <td><?= htmlspecialchars($row['remarks'] ?? '') ?></td>
                <td>
                    <a href="view_attendance.php?type=member&id=<?= urlencode($row['attendance_id']) ?>" class="action-btn btn-view" title="View">View</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
